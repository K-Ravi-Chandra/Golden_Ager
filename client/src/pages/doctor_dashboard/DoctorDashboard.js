...
const logout = () => {
  ...
  const renderSwitch = (item) => {
    switch(item) {
      ...
      case '2':
        return  <div>Critical Patients</div>;
      case '3':
        return  <div>Notifications</div> ;
      case '4':
            return  <div>{props.data} Hello Doctor</div> ;
      default:
        return <div>Help Requests</div>;
    }
  }
  ...
  const drawer = (
    <div>
      ...
      <List>
          ...
          <ListItem selected= {item === '1'} button onClick={() => handleClick('1')}  key= "My Patients" >
          <ListItemText 
            primaryTypographyProps={{
              fontSize: 18,
              fontWeight: 'medium',
          ...
          <ListItem selected= {item === '2'} button onClick={() => handleClick('2')}  key= "Critical Patients" >
          <ListItemText 
            primaryTypographyProps={{
              fontSize: 18,
              fontWeight: 'medium',
